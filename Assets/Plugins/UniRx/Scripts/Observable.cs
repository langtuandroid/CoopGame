...
namespace UniRx
{
    ...
    public static partial class Observable
    {
        ...
        public static IObservable<T> DoDefaultIfEmpty<T>(this IObservable<T> source, Func<T> doDefaultValue)
        {
            return new DoDefaultIfEmptyObservable<T>(source, doDefaultValue);
        }
